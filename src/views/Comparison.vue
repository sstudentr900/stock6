    ...
    <div class="flex-1 flex flex-col gap-6">
      <SharedItem title="試算結果">
        ...
        <template v-slot:content>
          ...
          <div class="text-sm text-gray-500">
            <div class="border-t border-solid border-gray-200 w-full flex items-center" v-for="(list,index) in state.lists" :key='index' :class="{'bg-blue-500/10':list.sell==state.sell}">
